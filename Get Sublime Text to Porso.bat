...
::https://www.sublimetext.com/download
 > %temp%\~tmp.vbs echo sUrl = "https://download.sublimetext.com/sublime_text_build_4107_x64.zip"
>> %temp%\~tmp.vbs echo sFolder = "%programfiles%\Software Portable\Sublime Text"
